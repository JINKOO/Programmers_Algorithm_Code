/*
 *  #. [ 카카오기출_2019 KAKAO BLIND RECRUITMENT :: 오픈 채팅방 ]
 *  
 *  #. 문제 설명
...
class Message {
	...
	Message(String uid, String nickName, String msg) {
		this.uid = uid;
...
public class Solution {
	...
	public String[] solution(String[] record) {
        ...
        for(int i = 0; i < record.length; i++) {
        	...
        	if(command.equals("Enter")) {
        		...
        		list.add(new Message(uid, nickName, "님이 들어갔습니다."));
        	}
        	
        	else if(command.equals("Leave")) {
        		list.add(new Message(uid, nickName, "님이 나갔습니다."));
        	}
        ...
        for(int i = 0; i < list.size(); i++) {
        	list.get(i).nickName = map.get(list.get(i).uid);
        	answer[i] = list.get(i).nickName + list.get(i).msg;
        }
	...
	public static void main(String[] args) {
		...
		sol.printResult(sol.solution(record));
		System.out.println("=============================");
		String[] record2 = {
				 
				"Leave uid0606",
				"Change uid0606 OhYeah",
				"Enter uid01 KO",
				"Enter uid02 Park"
		};
		sol.printResult(sol.solution(record2));
	}
}
